            ...
            child: SizedBox(
              ...
              child: FullCalendar(
                ...
                onDateChange: (value) {
                  ...
                  double widthUnit =
                      MediaQuery.of(context).size.width / 5 - 4.0;
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned(
              top: MediaQuery.of(context).size.height * .053,
              // right: -MediaQuery.of(context).size.height * .11,
              right: 0,
              left: 0,
              child: SizedBox(
                width: MediaQuery.of(context).size.width - (padding * 1),
                child: backButton
                    ? Row(
    ...
    return Container(
      child: Column(
        ...
        children: [
          ///name of the month
          Text(
            DateFormat.yMMM(Locale(locale!).toString()).format(first),
            style: TextStyle(
                fontSize: 18.0,
                color: widget.black,
                fontWeight: FontWeight.w400),
